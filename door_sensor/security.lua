-- ###############################################################
-- security.lua - functions to support reed switch magnetic door and
...
sensorID = "frontdoor_001"	-- a sensor identifier for this device
-- tgtHost = "MQTT_BROKER_IP_ADDR"	-- target host (broker)
tgtHost = "10.0.1.23"	-- target host (broker)
